...
function installEdit(){
    ...
    if(window.parent){
        ...
        if(url.href.indexOf("teachdoc=edit")!=-1){
            ...
            var renderBtn =  '<a ' + sty + ' class="menu-button fa icons" onClick="window.parent.location=\''+main+'plugin/adv_oel_tools_teachdoc/oel_tools_teachdoc_link.php?action=redir&idLudiLP='+localIdTeachdoc+'\'" >&nbsp;</a>';
